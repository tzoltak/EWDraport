...
#' @param zamien_znaki zmienna określająca, czy zamieniać znaki specjalne
#' latex'owe.
#' @return Funkcja nie zwraca żadnej wartości.
#' @export
drukuj_tabele = function(tabela, plikTabeliTex, znaczniki = NULL,
                         ostatniWiersz = NULL, precyzja = 3,  naglowek = TRUE,
                         zamien_znaki = TRUE ){
